...
In the following equations $y_t$ and $\hat{y}_t$ are the ground truth target 
...
fair holistic view of the models, but may be ineffective in capturing the 
...
trading energy. However, it has the same problem as \gls{wmape}, of becoming 
...
direction of the next price, meaning whether the price went up or down. This is 
useful for energy traders, however, directionality itself is not 
