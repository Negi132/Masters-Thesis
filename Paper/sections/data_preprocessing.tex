...
version of the \gls{dmi} data. Two test were performed to investigate the 
...
related to internal DMI quality control do not contain any metrological and are 
therefore
...
the decade of training data its feature data would be entirely
...
\cref{app:C} \autoref{tab:snapshot-pc-data}.
...
more useful to certain model types. Utilizing both mitigates the
...
essentially just copies of earlier data at various horizons. All
...
inherent access to yesterdays weather and consumption at this
...
included for the previous 24-hour, 48-hour, and 168-hour, as
